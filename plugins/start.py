...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        if not is_user_pro and user_id != OWNER_ID and not is_short_link and shortner_enabled:
            ...
            tutorial_link = getattr(client, 'tutorial_link', "https://t.me/Plus_adsMarket")
            ...
            await client.send_photo(
                ...
                reply_markup=InlineKeyboardMarkup([
                    ...
                    [
                        InlineKeyboardButton(" • Fᴏʀ ᴀᴅs •", url="https://t.me/Plus_adsMarket")
                    ]
                ])
            )
...
async def request_command(client: Client, message: Message):
    ...
    if not is_user_premium: 
        BUTTON_URL = "https://t.me/Plus_adsMarket"
        reply_markup = InlineKeyboardMarkup([
